module formalism.Physics21StepDelta where
...
------------------------------------------------------------------------
-- Concrete StepDelta instance for the widened `physics21` bridge slice.
--
...
Physics21State = P15.Physics15State
Exp6 = P15.Exp6
Delta6 = P15.Delta6

compile : Physics21State → Exp6
compile = P15.compile

infix 20 _↦₂₁_

data _↦₂₁_ : Physics21State → Physics21State → Set where
...
physics21-regime-valid : ∀ {x x'} (sx : x ↦₂₁ x') → RegimeWitness sx
physics21-regime-valid {x = x} physics4-scan-left-high =
...
physics21-regime-valid {x = x} physics5-shell-to-interior-latched-right =
  regime-witness conservative-contracting strictly-contracting conservative-bound
...
physics21-regime-valid {x = x} physics16-boundary-discharge-high =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics16-boundary-discharge-high))
physics21-regime-valid {x = x} physics17-boundary-handoff-left-to-mid =
  regime-witness transmuting-contracting strictly-contracting transmuting-bound
...
physics21-regime-valid {x = x} physics21-boundary-direct-reentry-mid =
  regime-witness conservative-contracting strictly-contracting conservative-bound
