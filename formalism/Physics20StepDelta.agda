module formalism.Physics20StepDelta where
...
------------------------------------------------------------------------
-- Concrete StepDelta instance for the widened `physics20` bridge slice.
--
...
Physics20State = P15.Physics15State
Exp6 = P15.Exp6
Delta6 = P15.Delta6

compile : Physics20State → Exp6
compile = P15.compile

infix 20 _↦₂₀_

data _↦₂₀_ : Physics20State → Physics20State → Set where
  ...
  physics20-tail-handoff-n0-to-nn :
...
deltaOf physics20-tail-handoff-n0-to-nn = P15.delta6 d0 dm1 d0 d0 d0 d0
...
delta-correct physics20-tail-handoff-n0-to-nn = refl
...
normalize-correct physics20-tail-handoff-n0-to-nn = refl
...
ruleClass physics20-tail-handoff-n0-to-nn = transmuting-contracting
...
physics20-regime-valid : ∀ {x x'} (sx : x ↦₂₀ x') → RegimeWitness sx
physics20-regime-valid {x = x} physics4-scan-left-high =
...
physics20-regime-valid {x = x} physics5-shell-to-interior-latched-right =
  regime-witness conservative-contracting strictly-contracting conservative-bound
...
physics20-regime-valid {x = x} physics16-boundary-discharge-high =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics16-boundary-discharge-high))
physics20-regime-valid {x = x} physics17-boundary-handoff-left-to-mid =
  regime-witness transmuting-contracting strictly-contracting transmuting-bound
...
physics20-regime-valid {x = x} physics18-boundary-discharge-mid =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics18-boundary-discharge-mid))
physics20-regime-valid {x = x} physics20-tail-handoff-n0-to-nn =
  regime-witness transmuting-contracting strictly-contracting transmuting-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics20-tail-handoff-n0-to-nn))

physics20-regime-valid {x = x} physics20-boundary-positive-discharge =
  regime-witness conservative-contracting strictly-contracting conservative-bound
