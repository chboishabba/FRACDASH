module formalism.Physics22StepDelta where
...
------------------------------------------------------------------------
-- Concrete StepDelta instance for the widened `physics22` bridge slice.
--
...
Physics22State = P15.Physics15State
Exp6 = P15.Exp6
Delta6 = P15.Delta6

compile : Physics22State → Exp6
compile = P15.compile

infix 20 _↦₂₂_

data _↦₂₂_ : Physics22State → Physics22State → Set where
  ...
  physics20-boundary-positive-discharge :
    P15.st G.zero G.zero G.zero G.negative G.zero G.positive ↦₂₂
    P15.st G.zero G.zero G.zero G.negative G.zero G.zero

  physics21-boundary-direct-reentry-mid :
    P15.st G.zero G.zero G.positive G.negative G.zero G.positive ↦₂₂
    P15.st G.zero G.zero G.positive G.positive G.zero G.positive

  physics22-boundary-direct-reentry-high :
    P15.st G.zero G.zero G.negative G.negative G.zero G.zero ↦₂₂
    P15.st G.zero G.zero G.negative G.positive G.zero G.zero
...
deltaOf physics20-boundary-positive-discharge = P15.delta6 d0 d0 d0 d0 d0 dm1
deltaOf physics21-boundary-direct-reentry-mid = P15.delta6 d0 d0 d0 dp2 d0 d0
deltaOf physics22-boundary-direct-reentry-high = P15.delta6 d0 d0 d0 dp2 d0 d0
...
delta-correct physics20-boundary-positive-discharge = refl
delta-correct physics21-boundary-direct-reentry-mid = refl
delta-correct physics22-boundary-direct-reentry-high = refl
...
normalize-correct physics20-boundary-positive-discharge = refl
normalize-correct physics21-boundary-direct-reentry-mid = refl
normalize-correct physics22-boundary-direct-reentry-high = refl
...
ruleClass physics20-boundary-positive-discharge = conservative-contracting
ruleClass physics21-boundary-direct-reentry-mid = conservative-contracting
ruleClass physics22-boundary-direct-reentry-high = conservative-contracting
...
physics22-regime-valid : ∀ {x x'} (sx : x ↦₂₂ x') → RegimeWitness sx
physics22-regime-valid {x = x} physics4-scan-left-high =
...
physics22-regime-valid {x = x} physics5-shell-to-interior-latched-right =
  regime-witness conservative-contracting strictly-contracting conservative-bound
...
physics22-regime-valid {x = x} physics16-boundary-discharge-high =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics16-boundary-discharge-high))
physics22-regime-valid {x = x} physics17-boundary-handoff-left-to-mid =
  regime-witness transmuting-contracting strictly-contracting transmuting-bound
...
physics22-regime-valid {x = x} physics18-boundary-discharge-mid =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics18-boundary-discharge-mid))
physics22-regime-valid {x = x} physics19-tail-handoff-n0-to-nn =
  regime-witness transmuting-contracting strictly-contracting transmuting-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics19-tail-handoff-n0-to-nn))

physics22-regime-valid {x = x} physics20-boundary-positive-discharge =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics20-boundary-positive-discharge))
physics22-regime-valid {x = x} physics21-boundary-direct-reentry-mid =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics21-boundary-direct-reentry-mid))
physics22-regime-valid {x = x} physics22-boundary-direct-reentry-high =
  regime-witness conservative-contracting strictly-contracting conservative-bound
    (G.realizeDelta-preserves-wellFormed primeExecution unitRealization (compile x) (deltaOf physics22-boundary-direct-reentry-high))
